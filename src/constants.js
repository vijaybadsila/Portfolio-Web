...
import Delimp from './assets/company_logo/delimp.png';
import agcLogo from './assets/company_logo/agc_logo.png';
import Concentrix from './assets/company_logo/concentrix.png';
...
export const SkillsInfo = [
  ...
  export const education = [
    ...
    },
    {
      id: 2,
      img: vpsLogo,
      school: "VivekaNand Inter College Garur Bageshwar",
      date: "Apr 2021 - March 2022",
      grade: "74%",
      desc: "I completed my class 12 education from VivekaNand Inter College, Garur, under the Uk board, where I studied Physics, Chemistry, and Biology (PCB) with Computer Science.",
